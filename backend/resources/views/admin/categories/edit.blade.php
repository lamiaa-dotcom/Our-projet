...
<body class="bg-gray-100">
    ...
    <main class="container mx-auto py-8">
        ...
        @endif
        <form action="{{ route('categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                @if ($category->image_path)
                    <img src="{{ asset('storage/' . $category->image_path) }}" alt="{{ $category->name }}" class="w-32 h-32 object-cover mb-2 rounded">
                @else
                    <p class="text-gray-500 mb-2">Aucune image définie.</p>
                @endif
